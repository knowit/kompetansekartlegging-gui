...
export declare class QuestionFormDefinitionConnection {
  ...
  static copyOf(source: QuestionFormDefinitionConnection, mutator: (draft: MutableModel<QuestionFormDefinitionConnection>) => MutableModel<QuestionFormDefinitionConnection> | void): QuestionFormDefinitionConnection;
}
...
export declare class FormDefinition {
  ...
  static copyOf(source: FormDefinition, mutator: (draft: MutableModel<FormDefinition>) => MutableModel<FormDefinition> | void): FormDefinition;
}
...
export declare class UserForm {
  ...
  static copyOf(source: UserForm, mutator: (draft: MutableModel<UserForm>) => MutableModel<UserForm> | void): UserForm;
}